...
const COLORKEYSET=['s','d']

function drawScoreAndPointTable(){
...
const COLORSSET=['blue','green'];//,'pink','yellow'];
...
function clearScoreAndPointsTable(){
